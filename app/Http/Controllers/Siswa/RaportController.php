...
class RaportController extends Controller
{
  public function index(Request $request)
  {
    ...
    return view('page.siswa.raport.main');
  }
  public function create()
  {
    ...
    return view('page.siswa.raport.input', ['task' => new Task, 'course' => $course, 'user' => $user]);
  }
  ...
  public function edit()
  {
    ...
    $room = Room::get();
    $user = User::where('role', 's')->get();
    return view('page.siswa.raport.list_detail', ['task' => new Task, 'course' => $course, 'user' => $user, 'raport' => $raport]);
  }
  ...
  {
    $data_siswa = Raport::where('siswa_id', Auth::user()->id)->first();
    $raport = Raport::where('siswa_id', Auth::user()->id)->get();
    $data = ['title' => 'Raport', 'raport' => $raport];
    $file_pdf = PDF::loadView('page.siswa.raport.pdf', $data);
    return $file_pdf->download($data_siswa->student->name . '_raport_' . $data_siswa->student->class->nama_kelas . '.pdf');
  }
}
